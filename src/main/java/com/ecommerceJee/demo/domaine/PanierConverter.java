...
public class PanierConverter
{
	...
	public static PanierVo toVo(Panier bo) {
		...
		vo.setId(bo.getId());
		vo.setUsername(bo.getUser().getUsername()); //COMMENT IF REGGRESSED

		//vo.setUser(UserConverter.toVo(bo.getUser())); //was commented dont know why
	...
	public static List<PanierVo> toVoList(List<Panier> boList) {
		...
		for (Panier panier : boList) {
			if(panier==null) System.out.println("UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU");
